          ...
          <div className="p-6">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-900 font-semibold text-lg">{t.success}</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-3 rounded-lg hover:shadow-lg transition mt-6"
                >
                  {t.send}
                </button>
              </form>
