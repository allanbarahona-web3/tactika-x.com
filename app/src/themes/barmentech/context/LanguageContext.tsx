...
const translations: Record<Language, Translations> = {
  es: {
    ...
    featureUp50: 'Hasta 50 productos',
    featureUnlimited: 'Productos ilimitados',
    featureBasicAnalytics: 'Análisis básico',
    featureAdvancedAnalytics: 'Análisis avanzado',
    featureEmailSupport: 'Soporte por email',
    featurePrioritySupport: 'Soporte prioritario',
    feature247Support: 'Soporte 24/7',
    featureCustomDomain: 'Dominio personalizado',
    featureAPIAccess: 'Acceso a API',
  ...
  en: {
    ...
    featureUp50: 'Up to 50 products',
    featureUnlimited: 'Unlimited products',
