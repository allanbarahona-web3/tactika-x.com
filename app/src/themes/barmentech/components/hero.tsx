      ...
      <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
        ...
        <div className="grid grid-cols-3 gap-16 pt-16 border-t border-white/20">
          <div className="text-center">
            <div className="text-5xl font-extrabold text-white mb-1 font-display">2,500+</div>
            <p className="text-white/90 text-sm">Active Stores</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-extrabold text-white mb-1 font-display">$50M+</div>
            <p className="text-white/90 text-sm">Sales Processed</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-extrabold text-white mb-1 font-display">99.9%</div>
            <p className="text-white/90 text-sm">Uptime</p>
          </div>
        </div>
      </div>
    </section>
